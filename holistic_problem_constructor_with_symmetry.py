...
if __name__ == '__main__':
    ...
    hubo_file_name = "files//hubo_222_with_symmetry.pkl"
    suggested_optimal = 7
    ...
    S = int(np.floor(suggested_optimal/2))
    ...
    for i in range(S):
        xs.append(list(reversed(xs[i])))
        ys.append(list(reversed(ys[i])))
        zs.append(list(reversed(zs[i])))
    
    xs.append([sym.symbols(str(S) + 'x' + str(0)), sym.symbols(str(S) + 'x' + str(1)), sym.symbols(str(S) + 'x' + str(1)), sym.symbols(str(S) + 'x' + str(0))])
    ys.append([sym.symbols(str(S) + 'y' + str(0)), sym.symbols(str(S) + 'y' + str(1)), sym.symbols(str(S) + 'y' + str(1)), sym.symbols(str(S) + 'y' + str(0))])
    zs.append([sym.symbols(str(S) + 'z' + str(0)), sym.symbols(str(S) + 'z' + str(1)), sym.symbols(str(S) + 'z' + str(1)), sym.symbols(str(S) + 'z' + str(0))])
